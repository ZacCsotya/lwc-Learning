...
export default class QuizApp extends LightningElement {
    ...
    correctAnswers = 0 // used to show the number of correct answers
    ...
    myQuestions = [
        ...
        {
            id:"Question 2",
            question:"Which of the following is an invalid file type in a LWC component folder?",
            answer:{
                a:".svg",
                b:".apex",
                c:".js"
    ...
    // changeHandler gets called on every click of an answer
    changeHandler(event){
